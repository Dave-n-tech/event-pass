<footer class="bg-gray-50 border-t border-gray-200 pt-10 pb-8">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1">
                ...
                <p class="mt-4 text-gray-600">
                    Discover and create amazing events in your city. Connect with your
            ...
            <!-- Platform Links -->
            <div class="col-span-1">
                <h3 class="font-semibold text-gray-900 mb-4">Platform</h3>
                <ul class="space-y-2">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('dashboard.create-event') }}" class="text-gray-600 hover:text-indigo-600">
                            Create Event
                        </a>
                    </li>
                    <li>
        ...
        <div class="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-600 text-sm">
                © {{ date('Y') }} EventTickr. All rights reserved.
            </p>
            <div class="flex space-x-4 mt-4 md:mt-0">
              ...
              0 015.45 2.525c.636-.247
              1.363-.416
              2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597
              0 2.917-.01
              ...
              3.097 0 00-.748-1.15
              3.098 3.098
              0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0
              1.802a3.333 3.333 0 100 6.666
              3.333 3.333 0 000-6.666zm5.338-3.205a1.2
              1.2 0 110 2.4
              1.2 1.2
              0 010-2.4z" clip-rule="evenodd" />
                    </svg>
                </a>
            </div>
        </div>
